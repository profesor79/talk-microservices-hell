...
//                Console.WriteLine("checking for alice");
//                if (alice == null)
//                {
//                    Console.WriteLine("creating alice");
...
//                    // a way of setting the password - we can set in as a random set of characters so
//                    // migrated users shall to reset it.
//                    // userMgr.AddPasswordAsync(alice, "newPass");
